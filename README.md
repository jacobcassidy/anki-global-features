...
| File                                                                                                                                                   | Purpose                                                                                                  |
| ------------------------------------------------------------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------------- |
| [\_global.js](https://github.com/jacobcassidy/anki-global-kit/blob/main/collection.media/_global.js)                                                   | Creates the Advanced Typed Inputs feature and shows/hides card details based on individual card data.    |
| [\_global.css](https://github.com/jacobcassidy/anki-global-kit/blob/main/collection.media/_global.css)                                                 | Sets the card styles shared between all cards. Can be overridden with specific card styles.              |
...
| [\_styles_for_syntax_highlighting.css](https://github.com/jacobcassidy/anki-global-kit/blob/main/collection.media/_styles_for_syntax_highlighting.css) | **Optional**: Styles for the [Syntax Highlighting (NG) addon](https://ankiweb.net/shared/info/566351439) |
